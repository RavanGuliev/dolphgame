...
const filteredCategories = computed(() => {
  ...
  return categories.value.data.filter((cat) =>
      ...
      <div class="row">
        ...
        <div class="col-xl-6 col-lg-5">
          <div class="custom-search-container">
            <form id="search" action="/" class="custom-search-form">
              <div class="input-group">
                <i class="fal fa-search search-icon"></i>
                <input v-model="search" class="custom-search-input" type="text" placeholder="Oyun, epin, ilan ara..." />
              </div>

              <div v-if="search.length > 0" class="custom-search-results">
                <div id="search-box">
