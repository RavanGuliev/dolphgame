...
useHead({
  title: 'MilliÖn ilə Balans Artırma'
});
                  ...
                  <div class="payment-card">
                    <div class="payment-header">
                      <div class="payment-logo">
                        <img src="/img/payments/million-logo.png" alt="MilliÖn" class="payment-method-logo">
                      </div>
                      <h4>MilliÖn</h4>
                      <h3>ilə Balans Artırma</h3>
                      <p>MilliÖn terminalları vasitəsilə hesab balansınızı dərhal artırın</p>
                    ...
                    <div class="commission-alert">
                      ...
                      <div class="alert-content">
                        ...
                        <p>MilliÖn terminalları vasitəsilə ödəniş edərkən <strong>3%</strong> komissiya tutulur. Məsələn, 100 AZN ödəyərkən balansınıza 97 AZN əlavə olunacaq.</p>
                      ...
                      <div class="instruction-steps">
                        <div class="step-item">
                          ...
                          <div class="step-content">
                            <h6>MilliÖn terminalına yaxınlaşın</h6>
                            <p>Sizə ən yaxın MilliÖn terminalını tapın</p>
                            <div class="step-icon">
