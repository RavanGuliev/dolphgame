...
useHead({ title: "MilliÖN ilə Balans Artırma" });
...
const steps = [
  { t: "Terminala yaxınlaşın", d: "Sizə ən yaxın MilliÖN terminalını tapın." },
        ...
        <div class="bg-white dark:bg-ink-800 rounded-2xl p-6 md:p-7 shadow-card border border-ink-200 dark:border-ink-700">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="flex items-center gap-3">
              <span class="w-11 h-11 rounded-xl bg-red-50 dark:bg-red-500/15 grid place-items-center text-red-600 dark:text-red-400 font-black text-[11px]">MLN</span>
              <div>
                <h2 class="text-lg md:text-xl font-extrabold tracking-tight text-ink-900 dark:text-white">MilliÖN Terminalı ilə ödəniş</h2>
