...
useHead({ title: "Express Pay ilə Balans Artırma" });
...
const steps = [
  { t: "Terminala yaxınlaşın", d: "Sizə ən yaxın Expresspay terminalını tapın." },
  { t: "Əyləncə və oyun bölməsini seçin", d: "Terminal ekranında «Əyləncə və oyun» bölməsinə keçin." },
        ...
        <div class="bg-white dark:bg-ink-800 rounded-2xl p-6 md:p-7 shadow-card border border-ink-200 dark:border-ink-700">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="flex items-center gap-3">
              <span class="w-11 h-11 rounded-xl bg-violet-50 dark:bg-violet-500/15 grid place-items-center text-violet-600 dark:text-violet-400 font-black text-[11px]">EXP</span>
              <div>
                <h2 class="text-lg md:text-xl font-extrabold tracking-tight text-ink-900 dark:text-white">Expresspay Terminalı ilə ödəniş</h2>
            ...
            <div class="bg-white dark:bg-ink-800 p-5 md:p-6 flex flex-col">
              ...
              <dl class="mt-5 space-y-5">
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div><dt class="text-[11px] text-ink-500 dark:text-ink-400">Terminal bölməsi</dt><dd class="text-sm font-semibold mt-0.5 text-ink-900 dark:text-white">Əyləncə və oyun → dolphgame.com</dd></div>
                </div>
                <div class="flex items-start gap-3">
