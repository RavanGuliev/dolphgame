...
useHead({ title: "M10 ilə Balans Artırma" });
...
const fee = computed(() => (Number(amount.value) || 0) * 0.015);
const result = computed(() => (Number(amount.value) || 0) - fee.value);
const quicks = [5, 10, 25, 50, 100];

const steps = [
  { t: "M10 tətbiqini açın", d: "Mobil telefonunuzda M10 tətbiqinə daxil olun." },
  { t: "Ödənişlər bölməsini seçin", d: "Tətbiqdə «Ödənişlər» və ya «Xidmətlər» bölməsinə keçin." },
  ...
  { t: "Ödənişi tamamlayın", d: "Balansınız 1,5% komissiya çıxılmaqla dərhal artırılacaq." },
];
</script>
        ...
        <div class="bg-white dark:bg-ink-800 rounded-2xl p-6 md:p-7 shadow-card border border-ink-200 dark:border-ink-700">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="flex items-center gap-3">
              <span class="w-11 h-11 rounded-xl bg-sky-50 dark:bg-sky-500/15 grid place-items-center text-sky-500 font-black text-[12px]">m10</span>
              <div>
                <h2 class="text-lg md:text-xl font-extrabold tracking-tight text-ink-900 dark:text-white">M10 tətbiqi ilə ödəniş</h2>
            ...
            <span class="shrink-0 text-[11px] font-bold px-2.5 py-1 rounded-full bg-brand-50 dark:bg-brand-500/15 text-brand-600 dark:text-brand-400">Komissiya 1,5%</span>
          </div>
          ...
          <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-px bg-ink-200 dark:bg-ink-700 rounded-2xl overflow-hidden border border-ink-200 dark:border-ink-700">
            ...
            <div class="bg-white dark:bg-ink-800 p-5 md:p-6 flex flex-col">
              ...
              <dl class="mt-5 space-y-5">
                ...
                <div class="flex items-start gap-3">
                  ...
                  <div><dt class="text-[11px] text-ink-500 dark:text-ink-400">Tətbiq bölməsi</dt><dd class="text-sm font-semibold mt-0.5 text-ink-900 dark:text-white">Ödənişlər → dolphgame.com</dd></div>
                </div>
                <div class="flex items-start gap-3">
              ...
              <p class="mt-auto pt-5 text-[11px] text-ink-500 dark:text-ink-400 leading-relaxed">Kodu M10 tətbiqinin <strong class="text-ink-700 dark:text-ink-200">«Müştəri kodu»</strong> xanasına daxil edərək ödənişi tamamlayın.</p>
            </div>
            ...
            <div class="bg-white dark:bg-ink-800 p-5 md:p-6 flex flex-col">
              <div class="flex items-center justify-between">
                ...
                <span class="text-[10px] font-semibold text-ink-400">1,5% komissiya</span>
              </div>
              ...
              <dl class="mt-5 space-y-3 text-sm">
                ...
                <div class="flex items-center justify-between"><dt class="text-ink-500 dark:text-ink-400">Komissiya (1,5%)</dt><dd class="text-brand-500 font-semibold">−{{ fmt(fee) }} AZN</dd></div>
              </dl>
