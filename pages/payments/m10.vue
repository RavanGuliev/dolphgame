...
useHead({ title: "M10 QR ilə Balans Artırma" });
...
const submitPayment = () => {
  ...
  $api
    .post("user/payment/balance", { amount: amount.value, payment_method: "wallet", wallet_id: "9" }, userStore.headers)
    .then((res) => {
        ...
        <div class="bg-white dark:bg-ink-800 rounded-2xl p-6 md:p-7 shadow-card border border-ink-200 dark:border-ink-700">
          <div class="flex flex-wrap items-start justify-between gap-3">
            <div class="flex items-center gap-3">
              ...
              <div>
                <h2 class="text-lg md:text-xl font-extrabold tracking-tight text-ink-900 dark:text-white">m10 QR ilə ödəniş</h2>
