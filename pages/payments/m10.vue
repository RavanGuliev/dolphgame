...
useHead({
  title: 'M10 QR ilə Balans Artırma'
});

// Commission rates for M10 - 1.5%
              ...
              <div class="col-md-12">
                <div class="online-payment-wrapper">
                  ...
                  <div class="payment-header-container">
                    <h4 class="payment-title">M10 QR ilə ödəniş etmək</h4>
                  ...
                  <div class="instruction-container">
                    ...
                    <div class="instruction-header">
                      <div class="instruction-logo">
                        <img src="/img/payments/m10-logo.png" alt="M10 QR" />
                      </div>
                      <div class="instruction-title-section">
                        <h5 class="instruction-title">M10 QR ilə necə ödəniş edilir?</h5>
                    ...
                    <ul class="instruction-list">
                      <li>Ekranda <strong>M10 QR</strong> kod açılacaq.</li>
                      <li>Mobil telefonunuzdan <strong>M10 tətbiqini</strong> açaraq <strong>QR kodu</strong> oxudun.</li>
                    </ul>
                    
                    <h6 class="instruction-subheading">Telefonla ödəniş edirsinzsə:</h6>
                    <ul class="instruction-list">
                      <li>M10 tətbiqi <strong>avtomatik</strong> açılacaq.</li>
...
.commission-row.paid .summary-value {
  color: #000;
}
